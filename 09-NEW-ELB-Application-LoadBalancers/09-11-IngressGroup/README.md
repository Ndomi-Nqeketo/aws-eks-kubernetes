...
```t
# Web URLs
http://ingress-groups-demo601.player-list.co.za/app1/index.html
http://ingress-groups-demo601.player-list.co.za/app2/index.html
http://ingress-groups-demo601.player-list.co.za
```
...
- The below records should be deleted automatically
  - ingress-groups-demo601.player-list.co.za
```