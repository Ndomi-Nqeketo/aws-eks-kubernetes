...
```t
# Policy ARN
arn:aws:iam::225908212644:policy/AllowExternalDNSUpdates
```  
...
eksctl create iamserviceaccount \
    ...
    --region us-east-1 \
    --cluster eksdemo1 \
    --attach-policy-arn arn:aws:iam::225908212644:policy/AllowExternalDNSUpdates \
    --approve \
    --override-existing-serviceaccounts
```
...
arn:aws:iam::225908212644:role/eksctl-eksdemo1-addon-iamserviceaccount-defa-Role1-JTO29BVZMA2N
```
...
default		external-dns			arn:aws:iam::225908212644:role/eksctl-eksdemo1-addon-iamserviceaccount-defa-Role1-JTO29BVZMA2N
kube-system	aws-load-balancer-controller	arn:aws:iam::225908212644:role/eksctl-eksdemo1-addon-iamserviceaccount-kube-Role1-EFQB4C26EALH
...
```yaml
    eks.amazonaws.com/role-arn: arn:aws:iam::225908212644:role/eksctl-eksdemo1-addon-iamserviceaccount-defa-Role1-JTO29BVZMA2N
```
