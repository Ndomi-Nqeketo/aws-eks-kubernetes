...
```t
# Change Directroy
cd 09-NEW-ELB-Application-LoadBalancers/
cd 09-01-Load-Balancer-Controller-Install
...
||                                                 Policy                                                 ||
|+--------------------------------+-----------------------------------------------------------------------+|
||  Arn                           |  arn:aws:iam::225908212644:policy/AWSLoadBalancerControllerIAMPolicy  ||
||  AttachmentCount               |  0                                                                    ||
||  CreateDate                    |  2024-07-24T07:39:13+00:00                                            ||
||  DefaultVersionId              |  v1                                                                   ||
||  IsAttachable                  |  True                                                                 ||
||  Path                          |  /                                                                    ||
||  PermissionsBoundaryUsageCount |  0                                                                    ||
||  PolicyId                      |  ANPATJGJNYOSIBPT4KAQK                                                ||
||  PolicyName                    |  AWSLoadBalancerControllerIAMPolicy                                   ||
||  UpdateDate                    |  2024-07-24T07:39:13+00:00                                            ||
|+--------------------------------+-----------------------------------------------------------------------+|
...
```t
# Policy ARN 
Policy ARN:  arn:aws:iam::225908212644:policy/AWSLoadBalancerControllerIAMPolicy
```
...
eksctl create iamserviceaccount \
  ...
  --attach-policy-arn=arn:aws:iam::225908212644:policy/AWSLoadBalancerControllerIAMPolicy \
...
helm install aws-load-balancer-controller eks/aws-load-balancer-controller \
  ...
  --set vpcId=vpc-0491821581e7d93fb \
